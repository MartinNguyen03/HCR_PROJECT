...
if("TRUE" STREQUAL "TRUE")
  set(pepper_sensors_py_SOURCE_PREFIX /catkin_ws/src/pepper_sensors_py)
  set(pepper_sensors_py_DEVEL_PREFIX /catkin_ws/devel/.private/pepper_sensors_py)
  ...
  set(pepper_sensors_py_INSTALL_PREFIX /catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pepper_sensors_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/catkin_ws/src/pepper_sensors_py/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /catkin_ws/devel/.private/pepper_sensors_py/lib;/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
